...
class TeamProfilePage extends React.Component {
    constructor() {
        super();
        this.state = { team: '', adminUser: '', description: '', usersToDelete: [], editTeam: false }
            ...
            return <div className="container profile profile-view" id="profile">
                    <div className="row profile-row">
                        <div className="col-md-4 relative">
                            <img src={this.state.team.teamAvatar} height="200" width="200"></img>
                        </div>
...
class TeamProfilePageEditable extends React.Component {
    constructor() {
        super();
        this.state = { description: '', region: '', rank: '',country: '',language: '', usersToDelete: [], avatar: '' }
    ...
    render() {
        return <div className="container profile profile-view" id="profile">
                <div className="row profile-row">
                    <div className="col-md-4 relative">
                        <img src={ this.props.team.teamAvatar } height="200" width="200"></img>
