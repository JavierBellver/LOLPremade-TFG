...
class TeamProfileComponent extends React.Component {
    constructor(props) {
        ...
        this.onInvitePlayerClosed = this.onInvitePlayerClosed.bind(this)
        ...
        return  <div>
                    ...
                    <div className="row">
                        <div role="group" className="pull-left">
                            ...
                            <button className="btn btn-danger" type="button">Leave team</button>
                        </div>
...
class TeamCard extends React.Component {
    ...
    componentDidMount() {
        var route = 'images/teams/' + this.props.team.name + 'avatar.jpeg';
    ...
    render() {
        return <div className="col-md-6" key={ this.props.team.id}>
                    <div className="card">
                        <img height="200" width="100" className="card-image" src={this.state.teamavatar} />
...
class TeamsSearchpage extends React.Component {
    ...
    render() {
        if(this.state.profileClickedId != '') {
            return <TeamPublicProfileComponent teamid={ this.state.profileClickedId } />
        }
        else {
            var items = [];
    ...
    render() {
        ...
        if (this.state.team != undefined && this.state.team != null) {
            teamComponent = <div className="container">
                                <TeamProfileComponent team={ this.state.team } />
                            </div>
        }
