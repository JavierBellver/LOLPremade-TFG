...
class UserCard extends React.Component {
    constructor() {
        super();
        this.state = { useravatar: '', sendMessageClicked: false, subject: '', messageBody: '' }
    ...
    checkImageExists(imageSrc) {
        var img = new Image();
        img.onload = function () { this.setState({ useravatar: imageSrc }) }.bind(this);
        img.onerror = function () { this.setState({ useravatar: 'images/add_friend_article_banner.jpg' }) }.bind(this);
        img.src = imageSrc;
    }
    onSeeProfileClicked() {
    ...
    componentDidMount() {
        var route = 'images/users/' + this.props.user.username + 'avatar.jpeg';
    ...
    render() {
        ...
        return <div className="col-md-6" key={ this.props.user.id}>
            ...
            <div className="card">
                <img height="200" width="100" className="card-image" src={this.state.useravatar} />
...
class UsersPage extends React.Component {
    ...
    render() {
        if(this.state.profileClickedId != '') {
            return <UserPublicProfileComponent userid={ this.state.profileClickedId } />
        }
        else {
            var items = [];
